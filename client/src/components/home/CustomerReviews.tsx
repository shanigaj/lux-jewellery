...
const reviews = [
  {
    ...
    text: "The engagement ring my fiancé chose from LUX Diamonds is absolutely breathtaking. The diamond brilliance is unlike anything I&apos;ve ever seen. The attention to detail in the platinum setting is truly remarkable. Every time I look at my hand, I fall in love all over again.",
  ...
  },
  {
    ...
    text: "I&apos;ve purchased jewellery from many luxury brands across the world, but LUX Diamonds stands apart. Their concierge service made the entire experience feel exclusive and personal. The tennis bracelet I bought for our anniversary exceeded every expectation.",
  ...
  },
  {
    ...
    text: "Surprised my wife with the Radiance Drop Earrings for our 10th anniversary. The tears of joy said it all. The packaging, the presentation, the reveal — LUX Diamonds made every moment magical. This is what luxury should feel like.",
